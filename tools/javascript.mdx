...
description: "Reference for apex-mcp JavaScript and CSS tools: add inline page JS, global JS via Page 0, page CSS, global CSS, and generate AJAX callback processes."
---
...
**Returns:** JSON with `status`, `function_name`, `filename`, `description`, `js_content` (prepared code ready to upload), `upload_instructions` (step-by-step list), and `reference_url` (e.g. `#APP_FILES#app-utils.js`).
