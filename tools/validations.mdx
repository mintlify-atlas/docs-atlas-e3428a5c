---
title: "Oracle APEX Item Validations and Computations Reference"
sidebarTitle: "Validations"
description: "apex-mcp tools for server-side item validations (NOT_NULL, REGEX, PL/SQL) and automatic value computations on Oracle APEX page items."
---
