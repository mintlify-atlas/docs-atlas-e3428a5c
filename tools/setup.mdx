...
description: "Reference for apex-mcp setup and diagnostic tools: setup guide, requirements check, permissions check and fix, health check, and template refresh."
---
