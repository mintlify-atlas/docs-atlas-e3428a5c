...
description: "apex-mcp is an MCP server with 116 tools for Oracle APEX 24.2. Build apps, generate CRUD pages, add charts, and manage schemas through any MCP-compatible AI client."
---
