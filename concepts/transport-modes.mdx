---
title: "apex-mcp Transport Modes: stdio, Streamable HTTP, and SSE"
sidebarTitle: "Transport Modes"
description: "apex-mcp supports three MCP transport modes: stdio for local AI clients, streamable HTTP for remote setups, and SSE for clients requiring it."
---
